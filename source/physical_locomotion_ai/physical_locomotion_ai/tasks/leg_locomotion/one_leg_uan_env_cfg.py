...
@configclass
class OneLegUANEnvCfg(DirectRLEnvCfg):
    """Real-to-sim actuator calibration task for the one-leg robot.

    The action is a residual feed-forward effort for hip, knee, and ankle.
    The nominal command remains the recorded hardware position target.
    """

    decimation = 2
    episode_length_s = 10.0
    action_space = 3
    observation_space = 120  # history_len * (q_error + dq_error) * 3 joints
    state_space = 0
    ...
    dataset_paths = (
        ...
        # "real_data/uan_walk_air_20260505_155448.csv",
        # "real_data/uan_walk_air_20260505_160026.csv",
    )
    history_len = 20
