...
parser.add_argument("--task", type=str, default="oneleg-uan-deploy", help="Gym task name.")
...
parser.add_argument("--log_root", type=str, default="logs/rsl_rl/one_leg_uan_deploy", help="Directory containing UAN runs.")
...
parser.add_argument(
    ...
    type=int,
    default=None,
    help="Optional UAN observation history length override. observation_space is set to history_len * per_step_observation_dim.",
)
...
def main():
    ...
    if args_cli.history_len is not None:
        env_cfg.history_len = args_cli.history_len
        env_cfg.observation_space = args_cli.history_len * env_cfg.per_step_observation_dim
